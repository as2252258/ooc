...
class Model extends BGii
{
    ...
    private $path = APP_PATH . '/model';

    private $oldContent = '';
    private $template = 'template/model.template';
    ...
    public function run()
    {
        ...
        $content = strtr($template, [
            '{$comment}' => $className,
            '{$service}' => $this->dataNamespace . $className,
        ]);
    ...
    {
        return realpath($this->path . '/' . $class . '.php');
    }
}
